...
sys_cputs(const char *s, size_t len)
{
	...
	// Nastavujem ci uzivatel ma pravo citat data od s po s+len , nechceme aby nam posielal fakeove adresy a oblbol jadro , neboj 
...
sys_env_destroy(envid_t envid)
{
	...
	if ((r = envid2env(envid, &e, 1)) < 0){      //ak vznikne chyba, tak sa odomkne a vrati chybu
...
{
	// LAB 4: Your code here.
	// Zistujem ci je adresa pod hranicou UTOP..
